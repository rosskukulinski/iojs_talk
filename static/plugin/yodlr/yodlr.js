...
(function(){
  ...
  // grab the lastest Yodlr library
  loadScript('https://'+HOST+'/static/js/YodlrClient.js', function() {
    // grab html config
    ROOMNAME = Reveal.getConfig().voiceRoom;
    APIKEY = Reveal.getConfig().voiceAPIKey;
    EMAIL = Reveal.getConfig().voiceEmail;

    // initialize Yodlr library
